...
void AddControls(HWND hWnd)
{
    ...
    hLogo = CreateWindowW(L"Static", NULL, WS_VISIBLE | WS_CHILD | SS_BITMAP, 200, 10, 100, 100, hWnd, NULL, NULL, NULL);
...
void loadImages()
{
    ...
    hLogoImage = (HBITMAP)LoadImageW(NULL, L"Batch-OS.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
}
